...
{	
	...
	<li><label for="label_id">Label</label>
	<?php	 	 echo $frm->getLabels('label_id'); ?></li>
    <li><label for="featured">Featured</label>
	<?php	 	 echo $frm->boolean('featured'); ?></li>
<?php	 	
}
...
function WPArtist_Meta_Music($post)
{
	...
	<li><label for="artist_id">Artist</label>
	<?php	 	 echo $frm->getArtists('artist_id'); ?></li>
    <li><label for="featured">Featured</label>
	<?php	 	 echo $frm->boolean('featured'); ?></li>
    <li><label for="release_date">Release Date</label>
	<?php	 	 echo $frm->text('release_date'); ?></li>
    <li><label for="amazon_url">Amazon Url</label>
	<?php	 	 echo $frm->text('amazon_url'); ?></li>
    <li><label for="itunes_url">iTunes Url</label>
	<?php	 	 echo $frm->text('itunes_url'); ?></li>
  <li>
      <label for="itunes_url">Custom Link 1</label><?php	 echo $frm->text('custom_url_1'); ?>Custom Link Text 1
	<?php	 	 echo $frm->text('custom_txt_1'); ?></li>
    <li><label for="itunes_url">Custom Link 2</label>
	<?php	 	 echo $frm->text('custom_url_2'); ?>Custom Link Text 2
	<?php	 	 echo $frm->text('custom_txt_2'); ?></li>
    <li><label for="itunes_url">Custom Link 3</label>
	<?php	 	 echo $frm->text('custom_url_3'); ?>Custom Link Text 3
	<?php	 	 echo $frm->text('custom_txt_3'); ?></li>
   <li> <label for="itunes_url">Custom Link 4</label>
	<?php	 	 echo $frm->text('custom_url_4'); ?>Custom Link Text 4
	<?php	 	 echo $frm->text('custom_txt_4'); ?></li>
    <li><label for="itunes_url">Custom Link 5</label>
	<?php	 	 echo $frm->text('custom_url_5'); ?>Custom Link Text 5
	<?php	 	 echo $frm->text('custom_txt_5'); ?></li>
    <li><label for="back_cover">Back Cover</label>
